...
var ProductWhere = struct {
	...
	Price:     whereHelpernull_Float32{field: "\"products\".\"price\""},
	Quantity:  whereHelpernull_Int64{field: "\"products\".\"quantity\""},
...
var (
	productAllColumns            = []string{"id", "name", "price", "quantity", "created_at", "updated_at", "deleted_at"}
	productColumnsWithoutDefault = []string{"id", "created_at"}
	productColumnsWithDefault    = []string{"name", "price", "quantity", "updated_at", "deleted_at"}
